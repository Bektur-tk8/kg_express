...
class Product(models.Model):
    ...
    subcategory = models.ForeignKey(SubCategory, on_delete=models.PROTECT, related_name="prodcuts") #Related name
...
class Review(models.Model):
    ...
    user_id = models.ForeignKey(User, "Пользователь", related_name="reviews")
